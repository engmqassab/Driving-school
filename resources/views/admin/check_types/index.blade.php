            ...
            <div class="card">
                ...
                <div class="card-body pt-5">
                    <div class="table-responsive">
                        <!--begin::Table-->
                        <table class="table align-middle table-row-dashed check-types-list-table fs-6 gy-5">
                            <!--begin::Table head-->
                            <thead>
                            <!--begin::Table row-->
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-title">{{__('أضافة فحص')}}</h5>
                    <!--begin::Close-->
...
@section('js')
    ...
    <script>
        var $url = "{{ route('admin.check-types.index') }}";
        var $deleteAllurl = "{{ route('admin.check-types-destroyAll') }}";
    ...
    <script>
        ...
        $(function() {
                ...
                if($(this).attr('id') == 'add_new'){
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('.check-types-list-table').DataTable().ajax.reload();
                            $("#add_new").html("{{ __('حفظ') }}");
                        },
                        error: function(data) {
                    ...
                    $.ajax({
                        data: $("#modal_add_new_form").serialize(),
                        url: "{{url('admin/check-types') }}" + '/' + record_id ,
                        type: "POST",
                        method: "PUT",
                        dataType: 'json',
                        success: function(data) {
            ...
            $('body').on('click', '.editRecord', function() {
                ...
                $.get("{{ url('admin/check-types') }}" + '/' + record_id + '/edit', function(data) {
                    $('#add_new').html("تعديل");
                    $('#modal-title').html('تعديل فحص');
