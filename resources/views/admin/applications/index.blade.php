            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3" style="padding-right:2px">
                            <div class="d-flex flex-column text-dark-75">
                                <span class="font-weight-bolder font-size-sm" style="margin-bottom: 15px;">{{__('نوع الاتفاق')}}</span>
                                <span  class="font-weight-bolder font-size-h5">
                        ...
                        <div class="col-sm-3" style="padding-right:2px">
                            <div class="d-flex flex-column text-dark-75">
                                <span class="font-weight-bolder font-size-sm" style="margin-bottom: 15px;">{{__('تاريخ الطلب')}}</span>
                                <span  class="font-weight-bolder font-size-h5">
                        ...
                        <div class="col-sm-3" style="padding-right:2px">
                            <div class="d-flex flex-column text-dark-75">
                                <span class="font-weight-bolder font-size-sm" style="margin-bottom: 15px;">{{__('نوع الرخصة')}}</span>
                                <span  class="font-weight-bolder font-size-h5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3" style="padding-right:2px">
                            <div class="d-flex flex-column text-dark-75">
                                <span class="font-weight-bolder font-size-sm" style="margin-bottom: 15px;">{{__('سعر الدرس النظري')}}</span>
                                <span class="font-weight-bolder font-size-h5">
                        ...
                        <div class="col-sm-3" style="padding-right:2px">
                            <div class="d-flex flex-column text-dark-75">
                                <span class="font-weight-bolder font-size-sm" style="margin-bottom: 15px;">{{__('سعر الدرس العملي')}}</span>
                                <span  class="font-weight-bolder font-size-h5">
                    ...
                    <div class="row">
                        <div class="col-sm-3" style="padding-right:2px">
                            <div class="d-flex flex-column text-dark-75">
                                <span class="font-weight-bolder font-size-sm" style="margin-bottom: 15px;">{{__('نوع النقل')}}</span>
                                <span  class="font-weight-bolder font-size-h5">
                        ...
                        <div class="col-sm-3" style="padding-right:2px">
                            <div class="d-flex flex-column text-dark-75">
                                <span class="font-weight-bolder font-size-sm" style="margin-bottom: 15px;">{{__('تاريخ النقل')}}</span>
                                <span  class="font-weight-bolder font-size-h5">
                        ...
                        <div class="col-sm-3" style="padding-right:2px">
                            <div class="d-flex flex-column text-dark-75">
                                <span class="font-weight-bolder font-size-sm" style="margin-bottom: 15px;">{{__('منقول من')}}</span>
                                <span  class="font-weight-bolder font-size-h5">
                    ...
                    <div class="row">
                        <div class="col-sm-3" style="padding-right:2px">
                            <div class="d-flex flex-column text-dark-75">
                                <span class="font-weight-bolder font-size-sm" style="margin-bottom: 15px;">{{__('نوع الفحص')}}</span>
                                <span  class="font-weight-bolder font-size-h5">
                        ...
                        <div class="col-sm-3" style="padding-right:2px">
                            <div class="d-flex flex-column text-dark-75">
                                <span class="font-weight-bolder font-size-sm" style="margin-bottom: 15px;">{{__('تاريخ الفحص')}}</span>
                                <span  class="font-weight-bolder font-size-h5">
                        ...
                        <div class="col-sm-3" style="padding-right:2px">
                            <div class="d-flex flex-column text-dark-75">
                                <span class="font-weight-bolder font-size-sm" style="margin-bottom: 15px;">{{__('نتيجة الفحص')}}</span>
                                <span  class="font-weight-bolder font-size-h5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6" style="padding-right:2px">
                            <div class="d-flex flex-column text-dark-75">
                                <span class="font-weight-bolder font-size-sm" style="margin-bottom: 15px;">{{__('ملاحظات')}}</span>
                                <span  class="font-weight-bolder font-size-h5">
