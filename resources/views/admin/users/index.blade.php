            ...
            <div class="card">
                ...
                <div class="card-body pt-5">
                    <div class="table-responsive">
                        <!--begin::Table-->
                        <table class="table align-middle table-row-dashed user-list-table fs-6 gy-5">
                            <!--begin::Table head-->
                            <thead>
                            <!--begin::Table row-->
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-title">{{__('أضافة مستخدم')}}</h5>
                    <!--begin::Close-->
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    ...
                    <form id="modal_add_new_form" class="form" action="javascript:void(0)">
                        ...
                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                            ...
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                <label class="required fw-bold fs-6 mb-2">{{__('اسم المستخدم')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="username" id="username" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="اسم المستخدم" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                <label class="required fw-bold fs-6 mb-2">{{__('البريد الالكتروني')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="email" id="email" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="الايميل" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                <label class="required fw-bold fs-6 mb-2">{{__('كلمه المرور')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="password" name="password" id="password"  class="form-control form-control-solid mb-3 mb-lg-0" placeholder="كلمه المرور" aria-describedby="basic-default-password"/>
                                <!--end::Input-->

                                <div id="button" class="btn btn-lg" onclick="genPassword()">إنشاء كلمة مرور
                                </div>
                            </div>
                            <!--end::Input group-->
                        </div>
...
@section('js')
    ...
    <script>
        ...
        var $deleteAllurl = "{{ route('admin.users-destroyAll') }}";
    ...
    <script>
        $('#modal_add_new_form').each(function () {
            var $this = $(this);
            $this.validate({
                rules: {
                    email: {required: true},
        ...
        $(function() {
            ...
            $('body').on('click', '.editRecord', function() {
                ...
                $.get("{{ url('admin/users') }}" + '/' + record_id + '/edit', function(data) {
                    $('#add_new').html("تعديل");
                    $('#modal-title').html('تعديل المستخدم');
