        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            ...
            <div class="page-title d-flex flex-column me-3">
                ...
                <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-gray-600">{{__('المركبات')}}</li>
                    <!--end::Item-->
                    <!--begin::Item-->
            ...
            <div class="card">
                ...
                <div class="card-body pt-5">
                    <div class="table-responsive">
                        <!--begin::Table-->
                        <table class="table align-middle table-row-dashed car-types-list-table fs-6 gy-5">
                            <!--begin::Table head-->
                            <thead>
                            <!--begin::Table row-->
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-title">{{__('أضافة نوع')}}</h5>
                    <!--begin::Close-->
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    ...
                    <form id="modal_add_new_form" class="form" action="javascript:void(0)">
                        ...
                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                            ...
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                <label class="required fw-bold fs-6 mb-2">{{__('الموديل')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="model" id="model" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="الموديل" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                <label class="required fw-bold fs-6 mb-2">{{__('سنة الصنع')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                ...
                <div class="modal-footer">
                    <button type="reset" class="btn btn-light me-3" data-modal-create-new-action="cancel" data-bs-dismiss="modal">
                        {{__('الغاء')}}</button>
                    <button type="submit" class="btn btn-primary"  form="modal_add_new_form" id="add_new"  data-modal-create-new-action="submit">
...
@section('js')
    ...
    <script>
        var $url = "{{ route('admin.car-types.index') }}";
        var $deleteAllurl = "{{ route('admin.car-types-destroyAll') }}";
    ...
    <script>
        ...
        $(function() {
                ...
                if($(this).attr('id') == 'add_new'){
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('.car-types-list-table').DataTable().ajax.reload();
                            $("#add_new").html("{{ __('حفظ') }}");
                        },
                        error: function(data) {
                    ...
                    $.ajax({
                        data: $("#modal_add_new_form").serialize(),
                        url: "{{url('admin/car-types') }}" + '/' + record_id ,
                        type: "POST",
                        method: "PUT",
                        dataType: 'json',
                        success: function(data) {
            ...
            $('body').on('click', '.editRecord', function() {
                ...
                $.get("{{ url('admin/car-types') }}" + '/' + record_id + '/edit', function(data) {
                    $('#add_new').html("تعديل");
                    $('#modal-title').html('تعديل النوع');
