            ...
            <div class="card">
                ...
                <div class="card-body pt-5">
                    <div class="table-responsive">
                        <!--begin::Table-->
                        <table class="table align-middle table-row-dashed trainers-list-table fs-6 gy-5">
                            <!--begin::Table head-->
                            <thead>
                            <!--begin::Table row-->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3" style="padding-right:2px">
                            <div class="d-flex flex-column text-dark-75">
                                <span class="font-weight-bolder font-size-sm" style="margin-bottom: 15px;">{{__('الهاتف')}}</span>
                                <span  class="font-weight-bolder font-size-h5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4" style="padding-right:2px">
                            <div class="d-flex flex-column text-dark-75">
                                <span class="font-weight-bolder font-size-sm" style="margin-bottom: 15px;">{{__('رقم الرخصة القياد')}}</span>
                                <span class="font-weight-bolder font-size-h5">
                                                    <span class="driving_license_number_span"></span></span>
                            </div>
                        </div>

                        <div class="col-sm-4" style="padding-right:2px">
                            <div class="d-flex flex-column text-dark-75">
                                <span class="font-weight-bolder font-size-sm" style="margin-bottom: 15px;">{{__('الدرجة')}}</span>
                                <span  class="font-weight-bolder font-size-h5">
                                                    <span class="driving_class_span"></span>
                                                </span>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4" style="padding-right:2px">
                            <div class="d-flex flex-column text-dark-75">
                                <span class="font-weight-bolder font-size-sm" style="margin-bottom: 15px;">{{__('تاريخ الانتهاء')}}</span>
                                <span  class="font-weight-bolder font-size-h5">
                                                    <span class="driving_license_end_date_span"></span>
                                                </span>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4" style="padding-right:2px">
                            <div class="d-flex flex-column text-dark-75">
                                <span class="font-weight-bolder font-size-sm" style="margin-bottom: 15px;">{{__('رقم الرخصة التدريب')}}</span>
                                <span class="font-weight-bolder font-size-h5">
                                                    <span class="training_license_number_span"></span></span>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4" style="padding-right:2px">
                            <div class="d-flex flex-column text-dark-75">
                                <span class="font-weight-bolder font-size-sm" style="margin-bottom: 15px;">{{__('الدرجة')}}</span>
                                <span  class="font-weight-bolder font-size-h5">
                                                    <span class="training_class_span"></span>
                                                </span>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4" style="padding-right:2px">
                            <div class="d-flex flex-column text-dark-75">
                                <span class="font-weight-bolder font-size-sm" style="margin-bottom: 15px;">{{__('تاريخ الانتهاء')}}</span>
                                <span  class="font-weight-bolder font-size-h5">
                                                    <span class="training_license_end_date_span"></span>
                                                </span>
                            </div>
...
@section('js')
    ...
    <script>
        var $url = "{{ route('admin.trainers.index') }}";
        var $deleteAllurl = "{{ route('admin.trainers-destroyAll') }}";
        var $createurl = "{{ route('admin.trainers.create') }}";
    ...
    <script>
        ...
        $(function() {
            ...
            $('body').on('click', '.showRecord', function() {
                ...
                $.get("{{ url('admin/trainers') }}" + '/' + record_id, function(data) {
                    ...
                    $('.driving_license_number_span').html(data.driving_license_number);
                    $('.driving_class_span').html(data.driving_class);
                    $('.driving_license_end_date_span').html(data.driving_license_end_date);
                    $('.training_license_number_span').html(data.training_license_number);
                    $('.training_class_span').html(data.training_class);
                    $('.training_license_end_date_span').html(data.training_license_end_date);
            ...
            $('#delete-record').click(function() {
                $.ajax({
                    type: "DELETE",
                    url: "{{url('admin/trainers') }}" + '/' + record_id,
                    beforeSend: function() {
                        $('#delete-record').html("{{ __('يتم الحذف..') }}");
                    },
                    success: function(data) {
                        $('#delete_modal').modal('hide');
                        $('.trainers-list-table').DataTable().ajax.reload();
