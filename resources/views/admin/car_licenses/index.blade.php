            ...
            <div class="card">
                ...
                <div class="card-body pt-5">
                    <div class="table-responsive">
                        <!--begin::Table-->
                        <table class="table align-middle table-row-dashed car-license-list-table fs-6 gy-5">
                            <!--begin::Table head-->
                            <thead>
                            <!--begin::Table row-->
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-title">{{__('أضافة ترخبص')}}</h5>
                    <!--begin::Close-->
...
@section('js')
    ...
    <script>
        var $url = "{{ route('admin.car-licenses.index') }}";
        var $deleteAllurl = "{{ route('admin.car-licenses-destroyAll') }}";
    ...
    <script>
        ...
        $(function() {
                ...
                if($(this).attr('id') == 'add_new'){
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('.car-license-list-table').DataTable().ajax.reload();
                            $("#add_new").html("{{ __('حفظ') }}");
                        },
                        error: function(data) {
                    ...
                    $.ajax({
                        data: $("#modal_add_new_form").serialize(),
                        url: "{{url('admin/car-licenses') }}" + '/' + record_id ,
                        type: "POST",
                        method: "PUT",
                        dataType: 'json',
                        success: function(data) {
            ...
            $('body').on('click', '.editRecord', function() {
                ...
                $.get("{{ url('admin/car-licenses') }}" + '/' + record_id + '/edit', function(data) {
                    $('#add_new').html("تعديل");
                    $('#modal-title').html('تعديل الترخيص');
