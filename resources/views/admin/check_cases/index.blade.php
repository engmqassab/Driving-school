            ...
            <div class="card">
                ...
                <div class="card-body pt-5">
                    <div class="table-responsive">
                        <!--begin::Table-->
                        <table class="table align-middle table-row-dashed check-cases-list-table fs-6 gy-5">
                            <!--begin::Table head-->
                            <thead>
                            <!--begin::Table row-->
...
@section('js')
    ...
    <script>
        var $url = "{{ route('admin.check-cases.index') }}";
        var $deleteAllurl = "{{ route('admin.check-cases-destroyAll') }}";
    ...
    <script>
        ...
        $(function() {
                ...
                if($(this).attr('id') == 'add_new'){
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('.check-cases-list-table').DataTable().ajax.reload();
                            $("#add_new").html("{{ __('حفظ') }}");
                        },
                        error: function(data) {
                    ...
                    $.ajax({
                        data: $("#modal_add_new_form").serialize(),
                        url: "{{url('admin/check-cases') }}" + '/' + record_id ,
                        type: "POST",
                        method: "PUT",
                        dataType: 'json',
                        success: function(data) {
            ...
            $('body').on('click', '.editRecord', function() {
                ...
                $.get("{{ url('admin/check-cases') }}" + '/' + record_id + '/edit', function(data) {
                    $('#add_new').html("تعديل");
