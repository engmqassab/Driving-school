...
(function (window, document, $) {
  ...
  $('.pickadate-translations').pickadate({
    ...
    $('.pickadate-ar').pickadate({
        ...
        weekdaysFull: ['الأحد' ,'السبت' ,'الجمعة', 'الخميس', 'الأربعاء', 'الثلاثاء', 'الاثنين'],
        weekdaysShort: ['الأحد' ,'السبت' ,'الجمعة', 'الخميس', 'الأربعاء', 'الثلاثاء', 'الاثنين'],
        today: 'اليوم',
        clear: 'اختيار واضح',
        close: 'إلغاء',
